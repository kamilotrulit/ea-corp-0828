...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1511601061);
...
user_pref("browser.laterrun.bookkeeping.profileCreationTime", 1511601031);
user_pref("browser.laterrun.bookkeeping.sessionCount", 1);
user_pref("browser.laterrun.enabled", true);
user_pref("browser.migration.version", 58);
user_pref("browser.newtabpage.activity-stream.migrationLastShownDate", 1511568000);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1511601048432");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1511602827432");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1511601037187");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1511604637187");
user_pref("browser.search.countryCode", "US");
user_pref("browser.search.region", "US");
user_pref("browser.slowStartup.averageTime", 1446);
user_pref("browser.slowStartup.samples", 1);
user_pref("browser.startup.homepage_override.buildID", "20171115095343");
...
user_pref("browser.urlbar.lastSuggestionsPromptDate", 20171125);
user_pref("browser.urlbar.timesBeforeHidingSuggestionsHint", 2);
user_pref("datareporting.policy.dataSubmissionPolicyAcceptedVersion", 2);
user_pref("datareporting.policy.dataSubmissionPolicyNotifiedTime", "1511601035062");
...
user_pref("e10s.rollout.cohortSample", "0.981798");
user_pref("e10s.rollout.cohortSample.multi", "0.827606");
...
user_pref("extensions.shield-recipe-client.user_id", "d0b4ad07-2392-4310-80c2-57b8165a8ab7");
user_pref("extensions.systemAddonSet", "{\"schema\":1,\"addons\":{}}");
user_pref("extensions.webextensions.uuids", "{\"screenshots@mozilla.org\":\"715428ee-8462-4cbe-b4d2-2cdf77a6833a\"}");
...
user_pref("places.history.expiration.transient_current_max_pages", 50529);
user_pref("plugin.disable_full_page_plugin_for_types", "application/pdf");
user_pref("signon.importedFromSqlite", true);
user_pref("toolkit.startup.last_success", 1511601030);
user_pref("toolkit.telemetry.cachedClientID", "9ac2556a-76b3-4db2-a294-9ffac8e867de");
user_pref("toolkit.telemetry.previousBuildID", "20171115095343");
